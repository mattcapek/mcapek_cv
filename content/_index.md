...
<div class="home-flex-container" style="display: flex; align-items: center; min-height: 220px; margin-top: 20px;">
  <div class="bio-paper-box">
    <div style="display: flex; flex-direction: column; align-items: flex-start;">
      ...
      <div style="margin-top: 2px; font-size: 0.8em; color: #555; text-align: left;"><a href="mailto:mcapek@fas.harvard.edu">mcapek@fas.harvard.edu</a></div>
    ...
    <div class="home-intro-text" style="display: flex; flex-direction: column; justify-content: center; height: 100%; width: 100%; text-align: left; margin-left: 48px;">
      <span>
      I’m driven by a fascination with the evolution of animal behavior—from molecules to neural circuits. I’m especially interested in sensory systems, and how interactions between species give rise to diversification and speciation. <br><br>
    I am currently a postdoctoral fellow in the lab of <a href="https://www.bellonolab.com" target="_blank" style="color: #337ab7; text-decoration: underline;">Dr. Nicholas Bellono</a> at Harvard University, where I study how cross-kingdom communication drives evolution, and how these processes shaped Earth’s earliest terrestrial ecosystems. <br><br>
